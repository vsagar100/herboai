export const translations = {
  en: {
    ...
    plantLibrary: {
      ...
      sortBotanical: "Botanical Name",
      sortFamily: "Family",
      sortAyush: "AYUSH System",
      ...
      families: "Families",
      noDatabase: "No plants in database.",
      habitat: "Habitat",
      sanskritName: "Sanskrit Name",
      commonNameHi: "Hindi Name",
      commonNameMr: "Marathi Name",
      description_label: "Description",
      partsUsed: "Parts Used",
      therapeuticActions: "Therapeutic Actions",
      rasa: "Rasa (Taste)",
      virya: "Virya (Potency)",
      vipaka: "Vipaka",
      doshaEffect: "Dosha Effect",
      prabhava: "Prabhava (Special Potency)",
      properties: "Properties / Guna",
      phytochemicals: "Phytochemicals",
      preparations: "Signature Preparations",
      contraindications: "Contraindications",
      interactions: "Interactions (Drug/Herb/Food)",
      classicalRef: "Classical References",
      associatedDiseases: "Associated Diseases & Remedies",
      efficacy: "Efficacy",
      evidence: "Evidence",
      dosage: "Dosage",
      equipment: "Equipment",
  ...
  hi: {
    ...
    plantLibrary: {
      ...
      sortBotanical: "वैज्ञानिक नाम",
      sortFamily: "कुल",
      sortAyush: "आयुष प्रणाली",
      ...
      families: "कुल (परिवार)",
      noDatabase: "डेटाबेस में कोई पौधे नहीं।",
      habitat: "आवास",
      sanskritName: "संस्कृत नाम",
      commonNameHi: "हिन्दी नाम",
      commonNameMr: "मराठी नाम",
      description_label: "विवरण",
      partsUsed: "प्रयुक्त भाग",
      therapeuticActions: "चिकित्सीय क्रियाएं",
      rasa: "रस (स्वाद)",
      virya: "वीर्य (शक्ति)",
      vipaka: "विपाक",
      doshaEffect: "दोष प्रभाव",
      prabhava: "प्रभाव (विशेष शक्ति)",
      properties: "गुण",
      phytochemicals: "फाइटोकेमिकल्स",
      preparations: "प्रमुख योग",
      contraindications: "मतभेद",
      interactions: "परस्पर क्रिया (दवा/जड़ी-बूटी/भोजन)",
      classicalRef: "शास्त्रीय संदर्भ",
      associatedDiseases: "संबंधित रोग और उपचार",
  ...
  mr: {
    ...
    plantLibrary: {
      ...
      next: "पुढील",
      sortBy: "क्रमवारी",
      sortNameAsc: "नाव (अ-ज्ञ)",
      sortNameDesc: "नाव (ज्ञ-अ)",
      sortBotanical: "वैज्ञानिक नाव",
      sortFamily: "कुळ",
      sortAyush: "आयुष प्रणाली",
      sortNewest: "नवीनतम आधी",
      gridView: "ग्रिड दृश्य",
      listView: "सूची दृश्य",
      totalPlants: "एकूण वनस्पती",
      endangered: "संकटग्रस्त",
      families: "कुळे",
      noDatabase: "डेटाबेसमध्ये वनस्पती नाहीत.",
      habitat: "अधिवास",
      sanskritName: "संस्कृत नाव",
      commonNameHi: "हिंदी नाव",
      commonNameMr: "मराठी नाव",
      description_label: "वर्णन",
      partsUsed: "वापरलेले भाग",
      therapeuticActions: "उपचारात्मक क्रिया",
      rasa: "रस (चव)",
      virya: "वीर्य (शक्ती)",
      vipaka: "विपाक",
      doshaEffect: "दोष प्रभाव",
      prabhava: "प्रभाव (विशेष शक्ती)",
      properties: "गुण",
      phytochemicals: "फायटोकेमिकल्स",
      preparations: "प्रमुख योग",
      contraindications: "विरोधाभास",
      interactions: "परस्परक्रिया (औषध/वनस्पती/अन्न)",
      classicalRef: "शास्त्रीय संदर्भ",
      associatedDiseases: "संबंधित रोग आणि उपचार",
